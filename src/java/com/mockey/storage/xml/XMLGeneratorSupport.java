...
class XmlGeneratorSupport {
     ...
     *
     * @param element the element containing the attribute to set
     * @param name    the name of the attribute to set
     * @param value   the value to set the attribute to; if <code>null</code>,
     ...
     * @param text     the text to be contained in the element; if <code>null</code>,
