...
public class MockeyXmlFileConfigurationParser {
    ...
    /**
     * @param inputSource - Mockey XML definition file, which is tightly tied to this
    ...
    public IMockeyStorage getMockeyStore(InputSource inputSource) throws org.xml.sax.SAXParseException,
        ...
        IMockeyStorage c = MockeyXmlFileConfigurationParser.fullSetDigester.parse(inputSource);
        return c;
    }

    /**
     * @param inputSource - XML fragment
     * @return
     * @throws org.xml.sax.SAXParseException
     * @throws java.io.IOException
     * @throws org.xml.sax.SAXException
