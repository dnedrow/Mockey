...
public class RequestInspectorDefinedByJson implements IRequestInspector {
    ...
    /**
     * @param json - request inspection rules
     ...
     * keyValues mapping.
     *
     * @param type      - Valid values are RULE_FOR_HEADERS or RULE_FOR_PARAMETERS
     * @param keyValues - An array of possible values associated to a key
