...
public class Service extends StatusCheck implements PersistableItem, ExecutableService, Serializable {
    ...
    /**
     * @param serviceResponseType - 0 (proxy), 1 (static), or 2 (dynamic). Any other value will
     *                            default to PROXY.
     */
    ...
    /**
     * @param _requestInspectorJsonRules can be null or empty or invalid JSON format to be able display
